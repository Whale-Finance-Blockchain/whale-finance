                ...
                <section className='w-full flex flex-col items-center'>
                    <div className="w-full h-[90vh] flex flex-col justify-center items-center bg-cover bg-[url('././assets/burj_khalifa_blue.png')]">
                        ...
                        <div className='w-full mt-16 mb-28 flex flex-row justify-center items-center'>
                            <li><a className="px-20 py-3 text-xm font-bold bg-blue-color text-white hover:bg-white hover:text-secondary-color transition duration-1000 ease-in-out rounded-full uppercase" href="/fundslist">Invest in Funds</a></li>
