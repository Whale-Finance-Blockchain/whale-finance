        ...
        <>
            {
                isMetamaskInstalled ? (
                    <div
                        ...
                        className='w-[16vw] right-[3vw] p-3 shadow-md font-bold bg-secondary-color hover:bg-primary-color text-white rounded-full cursor-pointer transition duration-1000 ease-in-out'
                    >
